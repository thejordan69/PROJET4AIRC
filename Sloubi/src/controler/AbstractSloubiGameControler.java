 ...
 *
 */
public abstract class AbstractSloubiGameControler implements SloubiGameControlers {

	protected SloubiGame sloubiGame;	 

	public AbstractSloubiGameControler(SloubiGame chessGame) {
		super();
